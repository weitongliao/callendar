...
package com.survivor.calendar.custom;
...
import com.survivor.calendarview.YearView;
...
public class CustomYearView extends YearView {
    ...
    protected void onDrawMonth(Canvas canvas, int year, int month, int x, int y, int width, int height) {
        ...
        String text = getContext()
                .getResources()
                .getStringArray(com.survivor.calendarview.R.array.month_string_array)[month - 1];
    ...
    protected void onDrawWeek(Canvas canvas, int week, int x, int y, int width, int height) {
        String text = getContext().getResources().getStringArray(com.survivor.calendarview.R.array.year_view_week_string_array)[week];
        canvas.drawText(text,
                x + width / 2,
                y + mWeekTextBaseLine,
                mWeekTextPaint);
