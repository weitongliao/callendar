 ...
 * 一般地，既然使用全屏日历，那也不必要
 * Created by huangsurvivor on 2019/3/7.
 */
    ...
    protected void initView() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TimePickerDialog timePicker = new TimePickerDialog(FullActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FullActivity.this, ListActivity.class);
